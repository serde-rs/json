...
//!
//! ```
//! # use sciformats_serde_json::{Number, Map};
//! #
//! # #[allow(dead_code)]
//! enum Value {
//!     Null,
...
//! [`sciformats_serde_json::from_str`][from_str] function. There is also [`from_slice`]
...
//! `sciformats_serde_json::Value` representation. And the Rust compiler can check that
...
#![doc(html_root_url = "https://docs.rs/serde_json/1.0.148")]
...
/// Functionality related to JSON value spans.
pub mod span;
